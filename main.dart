...
class DayData {
  ...
  bool get hasAmal {
    bool circleMarked = circles.values.any((v) => v == true);
    bool rectFilled = rects.values.any((v) => v.trim().isNotEmpty);
    return circleMarked || rectFilled;
  }
}
...
class TrackerProvider with ChangeNotifier {
  ...
  int getTrackedDaysCount() {
    // শুধুমাত্র সেই দিনগুলো গুনবে যেগুলোর প্রোগ্রেস ০ এর বেশি
